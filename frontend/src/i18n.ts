...
export const resources: Record<AppLanguage, TranslationTree> = {
  "zh-CN": {
    ...
    services: {
      ...
      openSourceHint: "按 GPT-SoVITS、IndexTTS、CosyVoice 选择服务后，粘贴 ComfyUI 地址并填写 TTS-Audio-Suite resource_id；配置只写入 data/local/services.json。",
      ...
      openSourceLocalRepoHint: "不再绑定本机项目路径；请启动 ComfyUI 后粘贴服务地址。",
      ...
      openSourceBaseUrl: "ComfyUI 地址",
      openSourceApiContract: "TTS-Audio-Suite 合同",
      openSourceResourceId: "Resource ID",
      openSourceResource: "资源组",
      openSourceCapacity: "容量",
      openSourceDetect: "检测连接",
      openSourceDetectAndSave: "检测并保存",
      openSourceGradioContract: "兼容协议",
      openSourceSave: "保存端点",
      openSourceSetupState: "检测结果",
      openSourceRepoFound: "服务配置",
  ...
  "en-US": {
    ...
    services: {
      ...
      openSourceHint: "Pick GPT-SoVITS, IndexTTS, or CosyVoice, then paste the ComfyUI URL and TTS-Audio-Suite resource_id. Saved config is written only to data/local/services.json.",
      ...
      openSourceLocalRepoHint: "Local repo binding is no longer used. Start ComfyUI and paste its service URL.",
      ...
      openSourceBaseUrl: "ComfyUI URL",
      openSourceApiContract: "TTS-Audio-Suite contract",
      openSourceResourceId: "Resource ID",
      ...
      openSourceGradioContract: "Compatibility contract",
      openSourceSave: "Save endpoint",
      openSourceSetupState: "Test result",
      openSourceRepoFound: "Service config",
